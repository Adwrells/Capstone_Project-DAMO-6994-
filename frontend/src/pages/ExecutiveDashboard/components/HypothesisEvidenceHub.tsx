...
const HYPOTHESIS_CARDS: HypothesisHubItem[] = [
  ...
  },
  {
    ...
    decision: 'Reject H₀',
    clinical_takeaway: 'Admitted inpatients experience over 4× longer emergency stays (median 10.60h) than non-admitted discharges (median 2.50h).',
  },
  {
    id: 'H3',
    ...
    test_statistic: 'Slope β = -1.94h / score',
    p_value: 0.0,
    effect_size: 'R² = 0.3163 (31.6% variance)',
    decision: 'Reject H₀',
    clinical_takeaway: 'Each unit increase in urgency score decreases expected ED stay by 1.94 hours (-116.60 min, p=3.49e-77).',
  },
  {
    id: 'H4',
