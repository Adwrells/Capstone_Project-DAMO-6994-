  ...
  return (
    ...
    >
      <div>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] text-slate-400">Comparing Inpatient Admission Proportions between Female and Male cohorts</p>
          </div>
        ...
        {/* Legend */}
        <div className="flex items-center justify-center gap-6 text-[11px] font-medium text-slate-500 dark:text-slate-400">
      ...
      <div className="pt-2.5 border-t border-slate-100 dark:border-[#1e2d4a] grid grid-cols-4 gap-2 text-center text-[10px]">
        ...
        <div className="p-1.5 rounded-lg bg-slate-50 dark:bg-[#182640]">
          <span className="text-slate-400 block text-[8px] font-bold uppercase">Chi-Square (χ²)</span>
          <span className="font-mono font-bold text-blue-600 dark:text-blue-400">χ² = 18,165</span>
        </div>
        <div className="p-1.5 rounded-lg bg-slate-50 dark:bg-[#182640]">
          <span className="text-slate-400 block text-[8px] font-bold uppercase">Cramér's V</span>
